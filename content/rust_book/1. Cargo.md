...
{{< admonition type="details" title="rustup show 输出示例" >}}
```
...
{{< admonition type="details" title="rustup component list 输出示例" >}}
```
...
{{< admonition type="info" title="Cargo.toml 默认内容" >}}
```toml
[package]
name = "hello_cargo"
version = "0.1.0"
...
{{< admonition type="info" title="main.rs 默认内容" >}}
```rust
fn main() {
    println!("Hello, world!");
}
