...
{{< admonition type="details" title="Background: Null（的存在）是一个十亿美元代价的错误<br/>- Tony Hoare, the inventor of `null`, “Null References: The Billion Dollar Mistake” 2009" >}}
...
{{< admonition type="details" title="何为 Happy Path - ChatGPT" >}}
