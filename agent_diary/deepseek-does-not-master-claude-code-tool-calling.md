...
可惜的是遵循的效果不怎么样，依然会在编辑失败之后第一时间采用旧的循环，所以我让Hermes Agent为我优化了一下提示词。Hermes告诉我原本的提示词语气太软...但我觉得和模型说强制的要求反而遵循效果不好，更重要的是给出目的和理由来。总之，Hermes根据我上面所写的那些，写出了目的更加明确的提示词，放到了全局CLAUDE.md里。
